...
var instrucciones = ['Utiliza las flechas de tu teclado para mover las piezas', 
'Ordena las piezas hasta que queden igual a la imágen que se muestra',
'Comienza cuando estes listo'];
...
function mostrarCartelGanador() {
  objetivo.innerHTML = 'ENHORABUENA!!! GANASTE EL JUEGO <br>🎉🎉🎉🎉🎉🎉';
  objetivo.setAttribute('id','ganaste');
}
...
function posicionValida(fila, columna) {
  if (fila < grilla.length && fila > -1 && columna < grilla.length && columna > -1) {
